...
<div class="col-md-7 col-sm-7 pull-right">
    <div class="panel panel-default">
        <div class="panel-heading alert-danger" style="padding-bottom: 0px">
            <div class="row">
            <span style="padding-left: 15px">Posts : ${topics.name}</span>
            <span>
                <g:form class="search-form col-md-4 pull-right"
                        controller="topic" action="search">
