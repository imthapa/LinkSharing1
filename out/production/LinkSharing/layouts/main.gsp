        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                <g:if test="${session.user}">
                    <li><span class="glyphicon glyphicon-chat navbar-glyphsize" data-toggle="modal" data-target="#topicCreate"/></li>
            ...
            %{--<span class="glyphicon glyphicon-file" data-toggle="modal" data-target="#docCreate"></span>--}%
                ...
                <span class="dropdown"><g:if test="${session.user}">
                    <span class="dropdown-toggle glyphicon glyphicon-user" id="menu1" data-toggle="dropdown">
